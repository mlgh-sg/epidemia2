...
The [multilevel tutorial](multilevel-multi-obs.html) fits a *related but
different* model to the same data and distributes the reduction differently,
placing a substantial part of it on social distancing. The two are not in conflict; they
...
```
## Chain 4 finished in 15863.6 seconds.
...
## Total execution time: 16568.6 seconds.
```
